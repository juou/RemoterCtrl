...
- (void)layoutSubviews {
    ...
    [NSDictionary dictionaryWithObject:[label font]
                                forKey:NSFontAttributeName];
    
    NSDictionary* detailattributes =
    [NSDictionary dictionaryWithObject:[detailsLabel font]
                                forKey:NSFontAttributeName];
	...
	CGSize detailsLabelSize = [detailsLabel.text sizeWithAttributes:detailattributes];
								//constrainedToSize:maxSize lineBreakMode:detailsLabel.lineBreakMode];
